...
import { Unsubscribe } from "../../common/electron";
...
export const subscribeCommandCallbackOnFinish = (commandId: string, callback: (result: CommandCallbackOnFinishResult) => void) : Unsubscribe => {
